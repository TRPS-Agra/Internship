...
@Component({
  selector: 'app-franchise-changepassword',
  templateUrl: './franchise-changepassword.component.html',
  styleUrls: ['./franchise-changepassword.component.css']
})
export class FranchiseChangepasswordComponent implements OnInit {
